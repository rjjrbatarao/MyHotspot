...
class CreateIptablefiltersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iptablefilters', function (Blueprint $table) {
            ...
            $table->string('reject_with')->nullable();
    ...
    {
        Schema::dropIfExists('iptablefilters');
    }
}
